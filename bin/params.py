...
tf.flags.DEFINE_string('train_file_name', 'data/data.csv', 'train file')
tf.flags.DEFINE_string('pre_trained_embedding_file_name', 'data/embedding.txt',
...
tf.flags.DEFINE_string('run_name', 'jack', 'A name for the run.')
...
tf.flags.DEFINE_integer('dict_min_freq', 0, 'minimum collection frequency of terms for dictionary. default: 0')
